...
public class KThread {
    ...
    if (this.waitingQueue == null){
        this.waitingQueue = ThreadedKernel.scheduler.newThreadQueue(true);
    }
    ...
    protected Condition2 joinCondition = new Condition2(joinLock);
